...
export const AMAZING: PracticeSong = {
  ...
  sections: [
    ...
    },
    {
      ...
      label: 'Chorus A',
      lines: [
        { lyrics: "I was stuck in my shame but now I've been set free", chords: [{ chord: 'F', position: 0 }, { chord: 'Fsus', position: 12 }] },
        { lyrics: 'I once was blind but now I see', chords: [{ chord: 'F', position: 0 }] },
        { lyrics: 'I was headed for hell until He rescued me', chords: [{ chord: 'Fsus', position: 0 }] },
        { lyrics: "Now Heaven's my home for all eternity", chords: [{ chord: 'F', position: 0 }] },
      ],
    },
    {
      type: 'chorus',
      ...
      lines: [
        { lyrics: "I was stuck in my shame but now I've been set free", chords: [{ chord: 'F', position: 0 }, { chord: 'Bb', position: 12 }] },
        { lyrics: 'I once was blind but now I see', chords: [{ chord: 'F', position: 0 }] },
        { lyrics: 'I was headed for hell until He rescued me', chords: [{ chord: 'Bb', position: 0 }] },
        { lyrics: "Now Heaven's my home for all eternity", chords: [{ chord: 'Dm', position: 0 }] },
      ],
    },
    {
      type: 'verse',
      label: 'Verse',
      lines: [
        { lyrics: 'I believe He died to save', chords: [{ chord: 'C', position: 0 }, { chord: 'Bb', position: 10 }] },
        ...
        { lyrics: "Isn't that amazing grace", chords: [{ chord: 'C', position: 0 }, { chord: 'Bb', position: 10 }] },
    ...
    },
    {
      ...
      label: 'Bridge (×4)',
      lines: [
        { lyrics: 'Hallelujah to the man on the middle cross', chords: [{ chord: 'F', position: 0 }, { chord: 'F/A', position: 12 }] },
        { lyrics: "He didn't owe the debt but He paid it off", chords: [{ chord: 'Dm', position: 0 }, { chord: 'Bb', position: 12 }] },
        { lyrics: "He rolled away the stone now I'm gettin' up", chords: [{ chord: 'F', position: 0 }, { chord: 'F/A', position: 13 }] },
        { lyrics: "I'm gettin' up I'm gettin' up", chords: [{ chord: 'Dm', position: 0 }, { chord: 'Bb', position: 8 }] },
      ],
    },
    {
      type: 'tag',
      ...
      lines: [
        {
          lyrics: "I'm gettin' up I'm gettin' up",
