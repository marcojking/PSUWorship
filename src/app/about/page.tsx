    ...
    >
      ...
      <main style={{ maxWidth: '680px', margin: '0 auto', padding: '0 1.5rem 6rem' }}>
        ...
        <section style={{ padding: '3rem 0' }}>
          ...
          <div style={{ background: '#1a1714', borderRadius: '16px', overflow: 'hidden' }}>
            ...
            <div style={{ padding: '1.75rem 2rem 2rem' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.25rem' }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontFamily: 'var(--font-source-sans)', fontSize: '0.55rem', fontWeight: 700, letterSpacing: '0.26em', textTransform: 'uppercase', color: 'rgba(196,121,58,0.7)', marginBottom: '0.6rem' }}>
                    WM&amp;A Student Band
                  </p>
                  <h2 style={{ fontFamily: 'var(--font-cormorant)', fontStyle: 'italic', fontWeight: 600, fontSize: 'clamp(1.8rem, 6vw, 2.5rem)', color: '#f5ead6', lineHeight: 1.1, marginBottom: '0.9rem' }}>
                    Gentle <span style={{ color: '#c4793a' }}>&amp;</span> Lowly
                  </h2>
                  <p style={{ fontSize: '0.9rem', fontWeight: 300, lineHeight: 1.7, color: 'rgba(245,234,214,0.6)', margin: 0 }}>
                ...
                <div style={{ flexShrink: 0, width: '80px', height: '80px', borderRadius: '8px', overflow: 'hidden', border: '1px solid rgba(196,121,58,0.3)', marginTop: '0.25rem' }}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src="/about/ep-art-flowers.jpg" alt="EP artwork" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                </div>
              </div>
            </div>
          </div>
